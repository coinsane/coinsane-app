...
export default {
  ...
  // Tab
  tabDefaultBg: "#1B152D",
  topTabBarTextColor: "#8D8A96",
  topTabBarFontFamily: "Lato-Medium",
  topTabBarFontSize: 14,
  topTabBarActiveTextColor: "#fff",
  topTabBarBorderColor: "#2F2A40",
  ...
  subtitleColor: platform === "ios" ? "#fff" : "#000",
