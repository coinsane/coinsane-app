...
export default (
  ...
  action: currenciesActions.ICurrencyAction,
): ICurrencyState => {
  switch (action.type) {
    case currenciesActions.ActionTypes.GET_AVAILABLE_CURRENCIES: {
      return {
        ...state,
    ...
    case currenciesActions.ActionTypes.GET_AVAILABLE_CURRENCIES_SUCCESS: {
    ...
    case currenciesActions.ActionTypes.GET_AVAILABLE_CURRENCIES_ERROR: {
      return {
        ...state,
    ...
    case currenciesActions.ActionTypes.SEARCH_AVAILABLE_CURRENCIES: {
    ...
    case currenciesActions.ActionTypes.SEARCH_AVAILABLE_CURRENCIES_SUCCESS: {
      const items = { ...state.items };
    ...
    case currenciesActions.ActionTypes.SEARCH_AVAILABLE_CURRENCIES_ERROR: {
      return {
        ...state,
        error: true,
        loading: false,
