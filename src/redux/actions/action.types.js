...
export const SEARCH_AVAILABLE_CURRENCIES = '[api] SEARCH_AVAILABLE_CURRENCIES';
export const SEARCH_AVAILABLE_CURRENCIES_SUCCESS = '[api] SEARCH_AVAILABLE_CURRENCIES_SUCCESS';
export const SEARCH_AVAILABLE_CURRENCIES_ERROR = '[api] SEARCH_AVAILABLE_CURRENCIES_ERROR';
...
export const UPDATE_CURRENCIES = '[settings] UPDATE_CURRENCIES';
export const UPDATE_CURRENCIES_SUCCESS = '[settings] UPDATE_CURRENCIES_SUCCESS';
export const UPDATE_CURRENCIES_ERROR = '[settings] UPDATE_CURRENCIES_ERROR';
